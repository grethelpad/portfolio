...
$user = "grethelc_adming"; //Your database username Does not change
$pass = "91W@s@bi"; // Your database user password
$db = "grethelc_group"; //Your database name you want to connect to - add your number to the end of this
