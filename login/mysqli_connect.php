...
$user = "grethelc_admin"; //Your database username Does not change
$pass = "91W@s@bi"; // Your database user password
$db = "grethelc_socialnetwork"; //Your database name you want to connect to - add your number to the end of this
